defmodule TorchReproWeb.PostControllerTest do
  use TorchReproWeb.ConnCase

  alias TorchRepro.Blog

  @create_attrs %{title: "some title", body: "some body", published_at: ~N[2024-08-24 18:26:00], published: true, views: 42}
